                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 transform-on-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="post_NZ.html" class="btn btn-outline-primary btn-rounded px-3 py-1 stretched-link"><small>View post</small></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 transform-on-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- call to action, use stretched-link class to make whole card clickable-->
                                    <a href="post_UK.html" class="btn btn-outline-primary btn-rounded px-3 py-1 stretched-link"><small>View post</small></a>
                                </div>
                            </div>
                        </div>
                    </div>
